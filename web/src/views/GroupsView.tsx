                ...
                {groups.map((g) => (
                  ...
                  >
                    ...
                    <td>
                      ...
                      >
                        {deletingId === g.group_id ? "..." : <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>}
                      </button>
                    </td>
                  </tr>
                ))}
                ...
                <div key={m.pubkey} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 0", borderBottom: "1px solid var(--border)" }}>
                  ...
                  <div style={{ display: "flex", gap: 8, alignItems: "center", flexShrink: 0 }}>
                    ...
                    <button
                      ...
                      onClick={(e) => { e.stopPropagation(); if (confirm(`Remove member ${m.pubkey.slice(0, 12)}... from group?`)) handleRemoveMember(selected.group_id, m.pubkey); }}
                    >
                      Remove
                    </button>
                  </div>
