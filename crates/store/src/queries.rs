...
impl Store {
    ...
    /// Supports filtering by ids, authors, kinds, #e/#p tags, and since/until/limit.
    pub fn query_events(
        &self,
        ids: &[String],
        authors: &[String],
    ...
    pub fn delete_replaceable_event(
        ...
        // Find events with matching kind, pubkey, and d-tag in their tags JSON
        // Tags are stored as JSON array like [["d","value"],...]
        // We use a LIKE match for the d-tag
    ...
    /// Used for kinds 0, 3, and 10000-19999.
